...
<html><head>
  ...
  <body>
    ...
    <div class="UserFeatureButtons">User<br>
      <button type="submit"><a href= "User/CreateUser.php">Add User</a></button>
      <button type="submit"><a href= "User/ReadUsers.php">View Users</a></button>
      <button type="submit"><a href= "User/UpdateUser.php">Edit User</a></button>
      <button type="submit"><a href= "User/DeleteUser.php">Delete User</a></button>
    </div><br>
